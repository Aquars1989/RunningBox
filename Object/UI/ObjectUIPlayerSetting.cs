...
namespace RunningBox
{
    ...
    /// 玩家資訊畫面
    /// </summary>
    public class ObjectUIPlayerSetting : ObjectUIPanel
    {
        ...
        public ObjectUIPlayerSetting(DirectionType anchor, int x, int y, MoveBase moveObject)
            : base(anchor, x, y, 330, 150, new DrawUIFrame(Color.AliceBlue, Color.CornflowerBlue, 2, 20), moveObject)
        {
            ...
            //玩家姓名
            _DrawPlayerName = new DrawUITextFrame(Color.Maroon, Color.LightGray, Color.FromArgb(230, 255, 245), Color.CornflowerBlue, 1, 10, GlobalPlayer.PlayerName, new Font("標楷體", 16), GlobalFormat.MiddleLeft) { TextPadding = new Padding(10, 10, 0, 5) };
