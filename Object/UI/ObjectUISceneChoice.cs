...
namespace RunningBox
{
    ...
    public class ObjectUISceneChoice : ObjectUIPanel
    {
            ...
            : base(x, y, width, height, DrawNull.Value)
        {
            ...
            _UIGroup1 = new ObjectUI(ContentAlignment.MiddleCenter, 0, 0, 200, 200, DrawNull.Value, new MoveStraight(TargetNull.Value, 1, 3000, 1, 100, 1F));
            _UIGroup2 = new ObjectUI(ContentAlignment.MiddleCenter, 0, 0, 200, 200, DrawNull.Value, new MoveStraight(TargetNull.Value, 1, 3000, 1, 100, 1F));
            ...
            _UIGroup1.MoveObject.Target = new TargetOffset(new TargetObject(this), new PointF(-130, 0));
            _UIGroup2.MoveObject.Target = new TargetOffset(new TargetObject(this), new PointF(130, 0));
        ...
        public int Mode
        {
            ...
            set
            {
                ...
                {
                    case 0:
                        (_UIGroup1.MoveObject.Target as TargetOffset).SetOffsetByXY(-130, 0);
                        (_UIGroup2.MoveObject.Target as TargetOffset).SetOffsetByXY(130, 0);
                        break;
                    case 1:
                        (_UIGroup1.MoveObject.Target as TargetOffset).SetOffsetByXY(-1000 + 130, 0);
                        (_UIGroup2.MoveObject.Target as TargetOffset).SetOffsetByXY(1000 - 130, 0);
